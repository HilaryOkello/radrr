...
let Radrr = (_dec = NearBindgen({}), _dec2 = initialize(), _dec3 = call({}), _dec4 = call({}), _dec5 = call({}), _dec6 = call({}), _dec7 = call({
  payableFunction: true
}), _dec8 = call({}), _dec9 = call({}), _dec0 = view(), _dec1 = view(), _dec10 = view(), _dec11 = view(), _dec12 = view(), _dec13 = view(), _dec14 = view(), _dec(_class = (_class2 = class Radrr {
  constructor() {
    this.owner = "";
    this.platformWallet = "";
  ...
  register_identity({
    ...
    if (this.identities.get(caller)) panicUtf8("Identity already registered");
    if (!pseudonym) panicUtf8("Pseudonym required");
    if (!world_id_hash) panicUtf8("World ID hash required");
  ...
  anchor_recording({
    ...
    const caller = predecessorAccountId();
    if (!this.identities.get(caller)) panicUtf8("Must register identity first");
    if (this.recordings.get(recording_id)) panicUtf8("Recording ID exists");
    const priceYocto = BigInt(Math.floor(parseFloat(price_near || "1") * 1e24)).toString();
    this.recordings.set(recording_id, {
      recording_id,
      merkle_root,
      gps_approx,
      timestamp: Number(blockTimestamp() / 1000000n),
      cid: null,
      encrypted_cid: null,
      witness: caller,
  ...
  update_cid({
    ...
    if (!recording) panicUtf8("Recording not found");
    if (recording.witness !== predecessorAccountId()) panicUtf8("Not witness");
    recording.cid = cid;
    this.recordings.set(recording_id, recording);
  }
  update_encrypted_cid({
    recording_id,
    encrypted_cid
  }) {
    if (predecessorAccountId() !== this.owner) panicUtf8("Platform only");
    const recording = this.recordings.get(recording_id);
    if (!recording) panicUtf8("Recording not found");
  ...
  purchase({
    ...
    const recording = this.recordings.get(recording_id);
    if (!recording) panicUtf8("Recording not found");
    if (recording.sold) panicUtf8("Already sold");
    if (recording.witness === caller) panicUtf8("Cannot buy own recording");
    const attached = attachedDeposit();
    const price = BigInt(recording.price_yocto);
    if (attached < price) panicUtf8("Insufficient payment");
    ...
    const promise1 = promiseBatchCreate(recording.witness);
    promiseBatchActionTransfer(promise1, witnessShare);
    const promise2 = promiseBatchCreate(this.platformWallet);
    promiseBatchActionTransfer(promise2, platformShare);
    const promise3 = promiseBatchCreate(this.safetyFundWallet);
    promiseBatchActionTransfer(promise3, safetyShare);
  }
...
}, _applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "register_identity", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "register_identity"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "anchor_recording", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "anchor_recording"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "update_cid", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "update_cid"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "update_encrypted_cid", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "update_encrypted_cid"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "purchase", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "purchase"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "update_corroboration", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "update_corroboration"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "increment_credibility", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "increment_credibility"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_recording", [_dec0], Object.getOwnPropertyDescriptor(_class2.prototype, "get_recording"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_identity", [_dec1], Object.getOwnPropertyDescriptor(_class2.prototype, "get_identity"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "is_purchased", [_dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "is_purchased"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_recordings_by_gps", [_dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "get_recordings_by_gps"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_recordings", [_dec12], Object.getOwnPropertyDescriptor(_class2.prototype, "get_recordings"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_recordings_by_witness", [_dec13], Object.getOwnPropertyDescriptor(_class2.prototype, "get_recordings_by_witness"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "total_recordings", [_dec14], Object.getOwnPropertyDescriptor(_class2.prototype, "total_recordings"), _class2.prototype), _class2)) || _class);
function total_recordings() {
  const _state = Radrr._getState();
  if (!_state && Radrr._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = Radrr._create();
  if (_state) {
    Radrr._reconstruct(_contract, _state);
  }
  const _args = Radrr._getArgs();
  const _result = _contract.total_recordings(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Radrr._serialize(_result, true));
}
function get_recordings_by_witness() {
  const _state = Radrr._getState();
  if (!_state && Radrr._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Radrr._getArgs();
  const _result = _contract.get_recordings_by_witness(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Radrr._serialize(_result, true));
}
function get_recordings() {
  ...
  const _args = Radrr._getArgs();
  const _result = _contract.get_recordings(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Radrr._serialize(_result, true));
}
function get_recordings_by_gps() {
  const _state = Radrr._getState();
  if (!_state && Radrr._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Radrr._getArgs();
  const _result = _contract.get_recordings_by_gps(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Radrr._serialize(_result, true));
}
function is_purchased() {
  ...
  const _args = Radrr._getArgs();
  const _result = _contract.is_purchased(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Radrr._serialize(_result, true));
}
function get_identity() {
  ...
  const _args = Radrr._getArgs();
  const _result = _contract.get_identity(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Radrr._serialize(_result, true));
}
function get_recording() {
  ...
  const _args = Radrr._getArgs();
  const _result = _contract.get_recording(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Radrr._serialize(_result, true));
}
function increment_credibility() {
  const _state = Radrr._getState();
  if (!_state && Radrr._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Radrr._getArgs();
  const _result = _contract.increment_credibility(_args);
  Radrr._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Radrr._serialize(_result, true));
}
function update_corroboration() {
  const _state = Radrr._getState();
  if (!_state && Radrr._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Radrr._getArgs();
  const _result = _contract.update_corroboration(_args);
  Radrr._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Radrr._serialize(_result, true));
}
function purchase() {
  ...
  const _args = Radrr._getArgs();
  const _result = _contract.purchase(_args);
  Radrr._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Radrr._serialize(_result, true));
}
function update_encrypted_cid() {
  const _state = Radrr._getState();
  if (!_state && Radrr._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Radrr._getArgs();
  const _result = _contract.update_encrypted_cid(_args);
  Radrr._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Radrr._serialize(_result, true));
}
function update_cid() {
  ...
  const _args = Radrr._getArgs();
  const _result = _contract.update_cid(_args);
  Radrr._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Radrr._serialize(_result, true));
}
function anchor_recording() {
  const _state = Radrr._getState();
  if (!_state && Radrr._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Radrr._getArgs();
  const _result = _contract.anchor_recording(_args);
  Radrr._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Radrr._serialize(_result, true));
}
function register_identity() {
  ...
  const _args = Radrr._getArgs();
  const _result = _contract.register_identity(_args);
  Radrr._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Radrr._serialize(_result, true));
}
function init() {
...
export { anchor_recording, get_identity, get_recording, get_recordings, get_recordings_by_gps, get_recordings_by_witness, increment_credibility, init, is_purchased, purchase, register_identity, total_recordings, update_cid, update_corroboration, update_encrypted_cid };
//# sourceMappingURL=radrr.js.map
